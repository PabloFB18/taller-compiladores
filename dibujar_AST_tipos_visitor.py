class VisitorTipos(object):
    ...
    def visit_var_declaration(self, var_declaration):
        ...
        if not var_declaration.numero_si_no:
            var = '-> ' + '"var' + str(id_var_declaration) + ': ' + var_declaration.type_specifier_t + ' ' + \
                        var_declaration.id_t + ' : ' + var_declaration.tipo + '"'
            self.ast += var + '\n'
        else:
            var = '-> ' + '"var' + str(id_var_declaration) + ': ' + var_declaration.type_specifier_t + ' ' + \
                        var_declaration.id_t + '[' + var_declaration.num_t + '] : ' + var_declaration.tipo + '"'
            self.ast += var + '\n'
    ...
    def visit_fun_declaration(self, fun_declaration):
        ...
        fun = '"function' + str(id_fun_declaration) + ': ' + fun_declaration.type_specifier_t + ' ' + \
            fun_declaration.id_t + ' : ' + fun_declaration.tipo + '"'
        self.ast += '-> ' + fun + '\n'
    ...
    def visit_expression(self, expression):
        ...
        self.ast += '-> "' + 'assign' + str(id_expression) + ' : ' + expression.tipo + '"' + '\n'
        self.ast += '\t"' + 'assign' + str(id_expression) + ' : ' + expression.tipo + '" '
    ...
    def visit_var(self, var):
        self.id_var += 1
        id_var = self.id_var
        self.ast += '-> "' + 'var' + str(id_var) + ': ' + var.id_t + ' : ' + var.tipo + '"' + '\n'
    ...
    def visit_term(self, term):
        ...
        self.ast += '-> "SIGNO' + str(id_term) + ': ' + term.mulop_t + ' : ' + term.tipo + '"' + '\n'
        self.ast += '\t"SIGNO' + str(id_term) + ': ' + term.mulop_t + ' : ' + term.tipo + '" '
    ...
    def visit_call(self, call):
        ...
        self.ast += '-> "' + 'call' + str(id_call) + ": " + call.id_t + ' : ' + call.tipo + '"' + '\n'
