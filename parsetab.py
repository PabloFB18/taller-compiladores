...
_lr_productions = [
  ...
  ('expression -> simple_expression','expression',1,'p_expression2','parser.py',221),
  ('var -> ID','var',1,'p_var1','parser.py',226),
  ('var -> ID ICORCH expression DCORCH','var',4,'p_var2','parser.py',231),
  ('simple_expression -> additive_expression relop additive_expression','simple_expression',3,'p_simple_expression1','parser.py',236),
  ('simple_expression -> additive_expression','simple_expression',1,'p_simple_expression2','parser.py',241),
  ('relop -> MENORI','relop',1,'p_relop1','parser.py',246),
  ('relop -> MENOR','relop',1,'p_relop2','parser.py',251),
  ('relop -> MAYOR','relop',1,'p_relop3','parser.py',256),
  ('relop -> MAYORI','relop',1,'p_relop4','parser.py',261),
  ('relop -> IGUAL','relop',1,'p_relop5','parser.py',266),
  ('relop -> DIST','relop',1,'p_relop6','parser.py',271),
  ('additive_expression -> additive_expression addop term','additive_expression',3,'p_additive_expression1','parser.py',276),
  ('additive_expression -> term','additive_expression',1,'p_additive_expression2','parser.py',281),
  ('addop -> SUMA','addop',1,'p_addop1','parser.py',286),
  ('addop -> RESTA','addop',1,'p_addop2','parser.py',291),
  ('term -> term mulop factor','term',3,'p_term1','parser.py',296),
  ('term -> factor','term',1,'p_term2','parser.py',301),
  ('mulop -> MULTI','mulop',1,'p_mulop1','parser.py',306),
  ('mulop -> DIVI','mulop',1,'p_mulop2','parser.py',311),
  ('factor -> IPAREN expression DPAREN','factor',3,'p_factor1','parser.py',316),
  ('factor -> var','factor',1,'p_factor2','parser.py',321),
  ('factor -> call','factor',1,'p_factor3','parser.py',326),
  ('factor -> NUM','factor',1,'p_factor4','parser.py',331),
  ('call -> ID IPAREN args DPAREN','call',4,'p_call','parser.py',336),
  ('args -> arg_list','args',1,'p_args1','parser.py',341),
  ('args -> empty','args',1,'p_args_empty','parser.py',346),
  ('arg_list -> arg_list COMA expression','arg_list',3,'p_arg_list1','parser.py',351),
  ('arg_list -> expression','arg_list',1,'p_arg_list2','parser.py',364),
