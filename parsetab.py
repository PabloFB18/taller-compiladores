...
_lr_productions = [
  ...
  ('selection_stmt -> IF IPAREN expression DPAREN statement','selection_stmt',5,'p_selection_stmt1','parser.py',192),
  ...
  ('return_stmt -> RETURN PUNTOC','return_stmt',2,'p_return_stmt1','parser.py',208),
  ('return_stmt -> RETURN expression PUNTOC','return_stmt',3,'p_return_stmt2','parser.py',214),
  ('expression -> var ASIGN expression','expression',3,'p_expression1','parser.py',219),
  ('expression -> simple_expression','expression',1,'p_expression2','parser.py',224),
  ('var -> ID','var',1,'p_var1','parser.py',229),
  ('var -> ID ICORCH expression DCORCH','var',4,'p_var2','parser.py',233),
  ('simple_expression -> additive_expression relop additive_expression','simple_expression',3,'p_simple_expression1','parser.py',237),
  ('simple_expression -> additive_expression','simple_expression',1,'p_simple_expression2','parser.py',241),
  ('relop -> MENORI','relop',1,'p_relop1','parser.py',245),
  ('relop -> MENOR','relop',1,'p_relop2','parser.py',249),
  ('relop -> MAYOR','relop',1,'p_relop3','parser.py',253),
  ('relop -> MAYORI','relop',1,'p_relop4','parser.py',257),
  ('relop -> IGUAL','relop',1,'p_relop5','parser.py',261),
  ('relop -> DIST','relop',1,'p_relop6','parser.py',265),
  ('additive_expression -> additive_expression addop term','additive_expression',3,'p_additive_expression1','parser.py',269),
  ('additive_expression -> term','additive_expression',1,'p_additive_expression2','parser.py',273),
  ('addop -> SUMA','addop',1,'p_addop1','parser.py',277),
  ('addop -> RESTA','addop',1,'p_addop2','parser.py',281),
  ('term -> term mulop factor','term',3,'p_term1','parser.py',285),
  ('term -> factor','term',1,'p_term2','parser.py',289),
  ('mulop -> MULTI','mulop',1,'p_mulop1','parser.py',293),
  ('mulop -> DIVI','mulop',1,'p_mulop2','parser.py',297),
  ('factor -> IPAREN expression DPAREN','factor',3,'p_factor1','parser.py',301),
  ('factor -> var','factor',1,'p_factor2','parser.py',305),
  ('factor -> call','factor',1,'p_factor3','parser.py',309),
  ('factor -> NUM','factor',1,'p_factor4','parser.py',313),
  ('call -> ID IPAREN args DPAREN','call',4,'p_call','parser.py',317),
  ('args -> arg_list','args',1,'p_args1','parser.py',321),
  ('args -> empty','args',1,'p_args_empty','parser.py',325),
  ('arg_list -> arg_list COMA expression','arg_list',3,'p_arg_list1','parser.py',329),
  ('arg_list -> expression','arg_list',1,'p_arg_list2','parser.py',333),
