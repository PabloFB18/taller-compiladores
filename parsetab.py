...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','test.py',50),
  ('statement -> expression','statement',1,'p_statement_expr','test.py',55),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','test.py',60),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','test.py',61),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','test.py',62),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','test.py',63),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','test.py',71),
  ...
  ('expression -> NAME','expression',1,'p_expression_name','test.py',86),
]
