...
_lr_productions = [
  ...
  ('program -> declaration_list','program',1,'p_program','parser.py',14),
  ('declaration_list -> declaration_list declaration','declaration_list',2,'p_declaration_list1','parser.py',19),
  ('declaration_list -> declaration','declaration_list',1,'p_declaration_list2','parser.py',32),
  ('declaration -> var_declaration','declaration',1,'p_declaration1','parser.py',37),
  ('declaration -> fun_declaration','declaration',1,'p_declaration2','parser.py',42),
  ('var_declaration -> type_specifier ID PUNTOC','var_declaration',3,'p_var_declaration1','parser.py',47),
  ('var_declaration -> type_specifier ID ICORCH NUM DCORCH PUNTOC','var_declaration',6,'p_var_declaration2','parser.py',52),
  ('type_specifier -> INT','type_specifier',1,'p_type_specifier1','parser.py',57),
  ('type_specifier -> VOID','type_specifier',1,'p_type_specifier2','parser.py',62),
  ('fun_declaration -> type_specifier ID IPAREN params DPAREN compound_stmt','fun_declaration',6,'p_fun_declaration','parser.py',67),
  ('params -> param_list','params',1,'p_params1','parser.py',72),
  ('params -> VOID','params',1,'p_params2','parser.py',77),
  ('param_list -> param_list COMA param','param_list',3,'p_param_list1','parser.py',82),
  ('param_list -> param','param_list',1,'p_param_list2','parser.py',95),
  ('param -> type_specifier ID','param',2,'p_param1','parser.py',100),
  ('param -> type_specifier ID ICORCH DCORCH','param',4,'p_param2','parser.py',105),
  ('compound_stmt -> ILLAVE local_declarations statement_list DLLAVE','compound_stmt',4,'p_compound_stmt','parser.py',110),
  ('local_declarations -> local_declarations var_declaration','local_declarations',2,'p_local_declarations1','parser.py',115),
  ('local_declarations -> empty','local_declarations',1,'p_local_declarations_empty','parser.py',128),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list1','parser.py',133),
  ('statement_list -> empty','statement_list',1,'p_statement_list_empty','parser.py',146),
  ('statement -> expression_stmt','statement',1,'p_statement1','parser.py',151),
  ('statement -> compound_stmt','statement',1,'p_statement2','parser.py',156),
  ('statement -> selection_stmt','statement',1,'p_statement3','parser.py',161),
  ('statement -> iteration_stmt','statement',1,'p_statement4','parser.py',166),
  ('statement -> return_stmt','statement',1,'p_statement5','parser.py',171),
  ('expression_stmt -> expression PUNTOC','expression_stmt',2,'p_expression_stmt1','parser.py',176),
  ('expression_stmt -> PUNTOC','expression_stmt',1,'p_expression_stmt2','parser.py',182),
  ('selection_stmt -> IF IPAREN expression DPAREN statement','selection_stmt',5,'p_selection_stmt1','parser.py',196),
  ('selection_stmt -> IF IPAREN expression DPAREN statement ELSE statement','selection_stmt',7,'p_selection_stmt2','parser.py',201),
  ('iteration_stmt -> WHILE IPAREN expression DPAREN statement','iteration_stmt',5,'p_iteration_stmt','parser.py',206),
  ('return_stmt -> RETURN PUNTOC','return_stmt',2,'p_return_stmt1','parser.py',211),
  ('return_stmt -> RETURN expression PUNTOC','return_stmt',3,'p_return_stmt2','parser.py',216),
  ('expression -> var ASIGN expression','expression',3,'p_expression1','parser.py',221),
  ('expression -> simple_expression','expression',1,'p_expression2','parser.py',226),
  ('var -> ID','var',1,'p_var1','parser.py',231),
  ('var -> ID ICORCH expression DCORCH','var',4,'p_var2','parser.py',236),
  ('simple_expression -> additive_expression relop additive_expression','simple_expression',3,'p_simple_expression1','parser.py',241),
  ('simple_expression -> additive_expression','simple_expression',1,'p_simple_expression2','parser.py',246),
  ('relop -> MENORI','relop',1,'p_relop1','parser.py',251),
  ('relop -> MENOR','relop',1,'p_relop2','parser.py',256),
  ('relop -> MAYOR','relop',1,'p_relop3','parser.py',261),
  ('relop -> MAYORI','relop',1,'p_relop4','parser.py',266),
  ('relop -> IGUAL','relop',1,'p_relop5','parser.py',271),
  ('relop -> DIST','relop',1,'p_relop6','parser.py',276),
  ('additive_expression -> additive_expression addop term','additive_expression',3,'p_additive_expression1','parser.py',281),
  ('additive_expression -> term','additive_expression',1,'p_additive_expression2','parser.py',286),
  ('addop -> SUMA','addop',1,'p_addop1','parser.py',291),
  ('addop -> RESTA','addop',1,'p_addop2','parser.py',296),
  ('term -> term mulop factor','term',3,'p_term1','parser.py',301),
  ('term -> factor','term',1,'p_term2','parser.py',306),
  ('mulop -> MULTI','mulop',1,'p_mulop1','parser.py',311),
  ('mulop -> DIVI','mulop',1,'p_mulop2','parser.py',316),
  ('factor -> IPAREN expression DPAREN','factor',3,'p_factor1','parser.py',321),
  ('factor -> var','factor',1,'p_factor2','parser.py',326),
  ('factor -> call','factor',1,'p_factor3','parser.py',331),
  ('factor -> NUM','factor',1,'p_factor4','parser.py',336),
  ('call -> ID IPAREN args DPAREN','call',4,'p_call','parser.py',341),
  ('args -> arg_list','args',1,'p_args1','parser.py',346),
  ('args -> empty','args',1,'p_args_empty','parser.py',351),
  ('arg_list -> arg_list COMA expression','arg_list',3,'p_arg_list1','parser.py',356),
  ('arg_list -> expression','arg_list',1,'p_arg_list2','parser.py',369),
